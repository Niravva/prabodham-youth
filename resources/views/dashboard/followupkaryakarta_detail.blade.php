...
@section('left_header_back_button')
    @if (in_array(get_current_admin_level(), [
        ...
        <a class="nav-link mr-3 pl-1" href="{{ route('dashboard.followupkaryakarta-list', $data[$request->id]['group_id']) }}"
            role="button">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="ml-2 card-title">{{ $data[$request->id]['groupName'] }} | {{ $data[$request->id]['name'] }}</span>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'followupkk', 'id' => $request->id, 'type' => 'today']) }}">
                                <div class="description-block border-right">
                        ...
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'followupkk', 'id' => $request->id, 'type' => 'tomorrow']) }}">
                                <div class="description-block border-right">
                        ...
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'followupkk', 'id' => $request->id, 'type' => 'thisweek']) }}">
                                <div class="description-block border-right">
                        ...
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'followupkk', 'id' => $request->id, 'type' => 'thismonth']) }}">
                                <div class="description-block">
