...
@section('left_header_back_button')
    <a class="nav-link mr-3 pl-1" href="{{ route('dashboard.sabha-detail', $request->id) }}" role="button">
        ...
        <div class="col-sm-12 p-0">
            <ul class="list">
                ...
                @foreach ($data as $key => $item)
                    <li>
                        <div class="col-sm-12">
                            <a href="{{ route('dashboard.group-detail', $item['id']) }}" class="row justify-content-between align-items-center">
                                <div class="col-11">
                                    <div>
