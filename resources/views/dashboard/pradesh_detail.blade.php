        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="ml-2 card-title">{{ $data['pradesh']['name'] }}</span>
                </div>
                <div class="card-body p-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <a href="{{ route('dashboard.zone-list', Auth::user()->pradesh_id) }}">
                                <div class="description-block border-right">
                                    <h5 class="description-header">{{ number_format($data['totalZone']) }}</h5>
                                    <span class="description-text text-muted">Total Zone</span>
                                </div>
                            </a>
                        </div>
                        <div class="col">
                            <div class="description-block border-right">
                                <h5 class="description-header">{{ number_format($data['totalSabha']) }}</h5>
                                <span class="description-text text-muted">Total Sabha</span>
                            </div>
                        </div>
                        <div class="col">
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'pradesh', 'id' => Auth::user()->pradesh_id, 'type' => 'today']) }}">
                                <div class="description-block border-right">
                        ...
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'pradesh', 'id' => Auth::user()->pradesh_id, 'type' => 'tomorrow']) }}">
                                <div class="description-block border-right">
                        ...
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'pradesh', 'id' => Auth::user()->pradesh_id, 'type' => 'thisweek']) }}">
                                <div class="description-block border-right">
                        ...
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'pradesh', 'id' => Auth::user()->pradesh_id, 'type' => 'thismonth']) }}">
                                <div class="description-block">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="ml-2 card-title">Sabha</span>
                </div>
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col">
                            <div class="description-block border-right">
                                <h5 class="description-header">{{ number_format($data['todaySabha']) }}</h5>
                                <span class="description-text text-muted">Today</span>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="description-block border-right">
                                <h5 class="description-header">{{ number_format($data['tomorrowSabha']) }}</h5>
                                <span class="description-text text-muted">Tomorrow</span>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="description-block">
                                <h5 class="description-header">{{ number_format($data['thiWeekSabha']) }}</h5>
                                <span class="description-text text-muted">This Week</span>
                            </div>
                        </div>
                    </div>
