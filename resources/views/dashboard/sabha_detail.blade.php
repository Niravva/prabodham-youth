...
@section('left_header_back_button')
    @if (in_array(get_current_admin_level(), ['Super_Admin', 'Country_Admin', 'State_Admin', 'Pradesh_Admin', 'Zone_Admin']))
        <a class="nav-link mr-3 pl-1" href="{{ route('dashboard.sabha-list', $data[$request->id]['zone_id']) }}"
            role="button">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="ml-2 card-title">{{ $data[$request->id]['zoneName'] }} | {{ $data[$request->id]['name'] }}</span>
                </div>
                <div class="card-body p-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <a href="{{ route('dashboard.group-list', $request->id) }}">
                                <div class="description-block border-right">
                                    <h5 class="description-header">{{ number_format($data['totalGroup']) }}</h5>
                                    <span class="description-text text-muted">Total Group</span>
                                </div>
                            </a>
                        </div>
                        <div class="col">
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'sabha', 'id' => $request->id, 'type' => 'today']) }}">
                                <div class="description-block border-right">
                        ...
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'sabha', 'id' => $request->id, 'type' => 'tomorrow']) }}">
                                <div class="description-block border-right">
                        ...
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'sabha', 'id' => $request->id, 'type' => 'thisweek']) }}">
                                <div class="description-block border-right">
                        ...
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'sabha', 'id' => $request->id, 'type' => 'thismonth']) }}">
                                <div class="description-block">
