...
@section('left_header_back_button')
    @if (in_array(get_current_admin_level(), ['Super_Admin', 'Country_Admin', 'State_Admin', 'Pradesh_Admin']))
        <a class="nav-link mr-3 pl-1" href="{{ route('dashboard.zone-list', $data[$request->id]['pradesh_id']) }}"
            role="button">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="ml-2 card-title">{{ $data[$request->id]['name'] }}</span>
                </div>
                <div class="card-body p-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <a href="{{ route('dashboard.sabha-list', $request->id) }}">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="ml-2 card-title">Youth <small class="text-muted">(Summary)</small></span>
                </div>
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col">
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'zone', 'id' => $request->id, 'type' => 'today']) }}">
                                <div class="description-block border-right">
                        ...
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'zone', 'id' => $request->id, 'type' => 'tomorrow']) }}">
                                <div class="description-block border-right">
                        ...
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'zone', 'id' => $request->id, 'type' => 'thisweek']) }}">
                                <div class="description-block border-right">
                        ...
                        <div class="col">
                            <a
                                href="{{ route('dashboard.birthday', ['for' => 'zone', 'id' => $request->id, 'type' => 'thismonth']) }}">
                                <div class="description-block">
